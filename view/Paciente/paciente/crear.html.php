...
<div class="container" style="    background-color: #909498;
    ...
    <h2>Registro Afiliado</h2>
			...
			<div class="form-group">
				...
				<div class="form-group col-md-3">
					<input type="number" class="form-control" required="required" id="CedulaUsuario" name="CedulaUsuario">
				</div>
			</div>
			...
			<div class="form-group">
				<label for="TipoUsuario" class="control-label col-md-3 col-sm-3 col-xs-12">Tipo Usuario *<span class="required"></span>
				</label>
				<div class="form-group col-md-3">
				...
				<label for="Correo" class="control-label col-md-3 col-sm-3 col-xs-12">Correo *<span class="required"></span>
				</label>
				<div class="form-group col-md-3">
					<input type="email" class="form-control" required="required" id="Correo" name="Correo">
				</div>
			</div>
